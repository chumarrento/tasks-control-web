        ...
        <VMain class="flex flex-col h-screen items-center justify-center">
            <div class="form-card">
                ...
                <VForm class="w-full" @submit.prevent="submit">
                    <VTextField v-model="form.data.email" label="Email" type="email" placeholder="Digite seu email" class="mb-2" />
                    <VTextField v-model="form.data.password" label="Senha" type="Password" placeholder="Digite sua senha" />
    
                    <section class="flex justify-end">
                        <VBtn type="submit">Entrar</VBtn>
                    </section>
                </VForm>
